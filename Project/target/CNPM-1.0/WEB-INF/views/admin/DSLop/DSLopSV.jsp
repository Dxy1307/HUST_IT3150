...
<head>
    ...
    <title>Lớp của gia sư</title>
</head>
<body>
<div class="board">
    <form action="<c:url value="/quan-tri/lop-cua-sinh-vien/danh-sach"/>" id="formSubmit" method="get">
                                        ...
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <c:url var="detailClassSV" value="/quan-tri/lop-cua-sinh-vien/danh-sach/chi-tiet">
                                                        <c:param name="id" value="${item.id}"/>
                                                    </c:url>
                                                    <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       title="Chi tiết" href='${detailClassSV}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                        </c:forEach>
