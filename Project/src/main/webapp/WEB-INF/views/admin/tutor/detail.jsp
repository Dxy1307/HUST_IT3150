...
<c:url var="TutorListUrl" value="/quan-tri/gia-su/danh-sach"/>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="fullName">Tên gia sư</label>
                                    <div class="col-sm-9">
...
<script>
    function turnback() {
        window.location.href = "${TutorListUrl}?page=1&limit=5&sortName=id&sortBy=asc";
    }
