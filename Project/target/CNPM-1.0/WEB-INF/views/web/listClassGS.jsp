...
<div class="inner-content">
    ...
    <!-- Danh sách các lớp -->
    <form action="<c:url value="/gia-su-tuyen-sinh"/>" id="formSubmit" method="get">
        <div class="padding-main" style="padding-bottom: 0;">
            <div class="container">
                <div class="row list-item">
                    <c:forEach var="item" items="${model.listResult}">
                        <c:url var="detailClassGS" value="/lop-hoc-gia-su">
                            <c:param name="id" value="${item.id}"/>
                        </c:url>
                        <a href="${detailClassGS}">
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                <div class="item-c">
                                    <div class="item-c-header cursor-pointer">
                                        ...
                                        <div class="item-c-sub mb-0">Mã số: GS${item.id}</div>
                                    ...
                                    <div class="item-c-footer d-flex justify-content-between">
                                        <%--<a href="javascript:void(0)">Đăng ký học </a>--%>
                                        Đăng ký học
                                        <a class="d-flex ml-auto" href="${detailClassGS}">
