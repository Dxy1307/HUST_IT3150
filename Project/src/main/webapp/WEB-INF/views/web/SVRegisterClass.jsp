...
<c:url var="registerClassSV" value="/api/sv-tao-lop"/>
<c:url var="SVRegisterClass" value="/sinh-vien-tao-lop"/>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>Gia sư gửi đăng ký lớp</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
...
<div class="adm-main">
    <div class="container">
        <div class="box-adm">
            <div class="left-adm">
                ...
                <div class="nav-adm">
                    <ul>
                        ...
                        <!---->
                        <li class="active"><a href="" class=""><span> GS tạo lớp tuyển học sinh </span></a></li> <!---->
                        <li class=""><a href="<c:url value="/phu-huynh-tao-lop?Id_Nguoitao=${user.id}"/>" class=""><span> PH tạo lớp tìm gia sư </span></a></li> <!---->
            ...
            <div class="right-adm">
                <!--Menu phải-->
                <form:form role="form" id="formRegisterClassSV" modelAttribute="model">
                    ...
                    <div class="bottom-right-adm">
                        ...
                        <button id="btnRegisterClassSV" name="btnRegisterClassSV" type="button" class="btn btn-primary">Lưu</button>
                    </div>
                </form:form>
            </div>
        </div>
...
<script>
    ...
    $('#btnRegisterClassSV').click(function (e) {
        e.preventDefault();
        let data = {};
        let formData = $('#formRegisterClassSV').serializeArray();
    ...
    function notiSuccess(notiMessage) {
        Swal.fire({
           ...
           if (result.isConfirmed) {
               window.location.href = "${SVRegisterClass}?Id_Nguoitao="+id_Nguoitao;
           }
        });
    }
</script>
