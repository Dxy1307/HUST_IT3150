...
<c:url var="DSLopSVUrl" value="/quan-tri/lop-cua-sinh-vien/danh-sach"/>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>Thông tin lớp học của gia sư</title>
</head>
<body>
<div class="board">
...
<script>
    function turnback() {
        window.location.href = "${DSLopSVUrl}?page=1&limit=5&sortName=id&sortBy=asc";
    }
</script>
</body>
</html>